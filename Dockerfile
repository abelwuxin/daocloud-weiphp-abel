...
#add by abel for install gd pdo_mysql
RUN docker-php-ext-configure gd --with-jpeg-dir=/usr/local/libjpeg
RUN docker-php-ext-configure gd --with-webp-dir=/usr/local/libwebp
RUN docker-php-ext-install -j4 gd pdo_mysql
